...
! function(t, e) {
    ...
    return function() {
        function e() {
            var i = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
            t(this, e), this.options = i, Object.assign(this, y, i), this.smartphone = y.smartphone, i.smartphone && Object.assign(this.smartphone, i.smartphone), this.tablet = y.tablet, i.tablet && Object.assign(this.tablet, i.tablet), this.smooth || "horizontal" != this.direction || console.warn("Ã°Å¸Å¡Â¨ `smooth:false` & `horizontal` direction are not yet compatible"), this.tablet.smooth || "horizontal" != this.tablet.direction || console.warn("Ã°Å¸Å¡Â¨ `smooth:false` & `horizontal` direction are not yet compatible (tablet)"), this.smartphone.smooth || "horizontal" != this.smartphone.direction || console.warn("Ã°Å¸Å¡Â¨ `smooth:false` & `horizontal` direction are not yet compatible (smartphone)"), this.init()
        }
        return i(e, [{
            key: "init",
            value: function() {
...
;
gsap.registerPlugin(ScrollTrigger);let scroll;const body=document.body,select=e=>document.querySelector(e),selectAll=e=>document.querySelectorAll(e);let dynamicNotchCleanup=null,dynamicNotchTimeline=null,stickyCursorTicker=null,scheduledScrollRefreshRaf=null,scheduledScrollRefreshTimeout=null;function getSecondCursor(){return document.querySelector(".second-circle")}function setSecondCursorHidden(e){const i=getSecondCursor();!i||window.innerWidth<=767||i.classList.toggle("hide-circles",!!e)}function resetSecondCursorState(){const e=getSecondCursor();e&&(gsap.killTweensOf(e),e.classList.remove("hide-circles"),gsap.set(e,{opacity:1,scale:1}))}function shrinkSecondCursor(){const e=getSecondCursor();!e||window.innerWidth<=767||TweenLite.to(e,.3,{opacity:1,scale:0})}function restoreSecondCursor(){const e=getSecondCursor();!e||window.innerWidth<=767||TweenLite.to(e,.3,{opacity:1,scale:1})}function moveCircle(e){const i=getSecondCursor();i&&TweenLite.to(i,.4,{x:e.clientX,y:e.clientY})}function handleMouseMove(e){window.innerWidth>767&&moveCircle(e)}function initSecondCursor(){resetSecondCursorState(),$(window).off("mousemove.mattiaSecondCursor").on("mousemove.mattiaSecondCursor",handleMouseMove),$(document).off("mouseenter.mattiaSecondCursorLinks mouseleave.mattiaSecondCursorLinks","a").on("mouseenter.mattiaSecondCursorLinks","a",shrinkSecondCursor).on("mouseleave.mattiaSecondCursorLinks","a",restoreSecondCursor)}function scheduleScrollRefresh(e=0){const i=function(){typeof ScrollTrigger!="undefined"&&typeof ScrollTrigger.refresh=="function"&&ScrollTrigger.refresh(),scroll&&typeof scroll.update=="function"&&scroll.update(),scheduledScrollRefreshRaf=null},t=function(){scheduledScrollRefreshRaf&&cancelAnimationFrame(scheduledScrollRefreshRaf),scheduledScrollRefreshRaf=requestAnimationFrame(function(){scheduledScrollRefreshRaf=requestAnimationFrame(i)})};if(e>0){scheduledScrollRefreshTimeout&&clearTimeout(scheduledScrollRefreshTimeout),scheduledScrollRefreshTimeout=window.setTimeout(function(){scheduledScrollRefreshTimeout=null,t()},e);return}t()}initCLSDebugObserver(),initPageTransitions();function initLoaderHome(){var e=gsap.timeline();e.set(".loading-screen",{top:"0"}),e.set("main .once-in",{autoAlpha:0}),e.set(".loading-words",{opacity:0,y:-50}),e.set(".loading-words .active",{display:"none"}),e.set(".loading-words .home-active, .loading-words .home-active-last",{display:"block",opacity:0}),e.set(".loading-words .home-active-first",{opacity:1}),$(window).width()>540?e.set(".loading-screen .rounded-div-wrap.bottom",{height:"10vh"}):e.set(".loading-screen .rounded-div-wrap.bottom",{height:"5vh"}),e.set("html",{cursor:"wait"}),e.call(function(){scroll.stop()}),e.to(".loading-words",{duration:.8,opacity:1,y:-50,ease:"Power4.easeOut",delay:.5}),e.to(".loading-words .home-active",{duration:.01,opacity:1,stagger:.15,ease:"none",onStart:i},"=-.4");function i(){gsap.to(".loading-words .home-active",{duration:.01,opacity:0,stagger:.15,ease:"none",delay:.15})}e.to(".loading-words .home-active-last",{duration:.01,opacity:1,delay:.15}),e.to(".loading-screen",{duration:.8,top:"-100%",ease:"Power4.easeInOut",delay:.2}),e.to(".loading-screen .rounded-div-wrap.bottom",{duration:1,height:"0vh",ease:"Power4.easeInOut"},"=-.8"),e.to(".loading-words",{duration:.3,opacity:0,ease:"linear"},"=-.8"),e.set(".loading-screen",{top:"calc(-100%)"}),e.set(".loading-screen .rounded-div-wrap.bottom",{height:"0vh"}),e.to("main .once-in",{duration:1.5,autoAlpha:1,stagger:.07,ease:"Expo.easeOut",clearProps:!0},"=-.8"),e.set("html",{cursor:"auto"},"=-1.2"),e.call(function(){scroll.start()})}function initLoader(){var e=gsap.timeline();e.set(".loading-screen",{top:"0"}),e.set("main .once-in",{autoAlpha:0}),e.set(".loading-words",{opacity:1,y:-50}),$(window).width()>540?e.set(".loading-screen .rounded-div-wrap.bottom",{height:"10vh"}):e.set(".loading-screen .rounded-div-wrap.bottom",{height:"5vh"}),e.set("html",{cursor:"wait"}),e.to(".loading-screen",{duration:.8,top:"-100%",ease:"Power4.easeInOut",delay:.5}),e.to(".loading-screen .rounded-div-wrap.bottom",{duration:1,height:"0vh",ease:"Power4.easeInOut"},"=-.8"),e.to(".loading-words",{duration:.3,opacity:0,ease:"linear"},"=-.8"),e.set(".loading-screen",{top:"calc(-100%)"}),e.set(".loading-screen .rounded-div-wrap.bottom",{height:"0vh"}),e.to("main .once-in",{duration:1,autoAlpha:1,stagger:.05,ease:"Expo.easeOut",clearProps:"true"},"=-.8"),e.set("html",{cursor:"auto"},"=-.8")}function pageTransitionIn(){var e=gsap.timeline();e.call(function(){scroll.stop()}),e.set(".loading-screen",{top:"100%"}),e.set(".loading-words",{opacity:0,y:0}),e.set("html",{cursor:"wait"}),$(window).width()>540?e.set(".loading-screen .rounded-div-wrap.bottom",{height:"10vh"}):e.set(".loading-screen .rounded-div-wrap.bottom",{height:"5vh"}),e.to(".loading-screen",{duration:.5,top:"0%",ease:"Power4.easeIn"}),$(window).width()>540?e.to(".loading-screen .rounded-div-wrap.top",{duration:.4,height:"10vh",ease:"Power4.easeIn"},"=-.5"):e.to(".loading-screen .rounded-div-wrap.top",{duration:.4,height:"10vh",ease:"Power4.easeIn"},"=-.5"),e.to(".loading-words",{duration:.8,opacity:1,y:-50,ease:"Power4.easeOut",delay:.05}),e.set(".loading-screen .rounded-div-wrap.top",{height:"0vh"}),e.to(".loading-screen",{duration:.8,top:"-100%",ease:"Power3.easeInOut"},"=-.2"),e.to(".loading-words",{duration:.6,opacity:0,ease:"linear"},"=-.8"),e.to(".loading-screen .rounded-div-wrap.bottom",{duration:.85,height:"0",ease:"Power3.easeInOut"},"=-.6"),e.set("html",{cursor:"auto"},"=-0.6"),$(window).width()>540?e.set(".loading-screen .rounded-div-wrap.bottom",{height:"10vh"}):e.set(".loading-screen .rounded-div-wrap.bottom",{height:"5vh"}),e.set(".loading-screen",{top:"100%"}),e.set(".loading-words",{opacity:0})}function pageTransitionOut(){var e=gsap.timeline();e.set("main .once-in",{autoAlpha:0}),e.call(function(){scroll.start()}),e.to("main .once-in",{duration:1,autoAlpha:1,stagger:.05,ease:"Expo.easeOut",delay:.8,clearProps:"true"})}function initPageTransitions(){barba.hooks.before(()=>{select("html").classList.add("is-transitioning")}),barba.hooks.after(()=>{select("html").classList.remove("is-transitioning"),scroll.init(),scroll.stop()}),barba.hooks.enter(()=>{scroll.destroy()}),barba.hooks.afterEnter(()=>{window.scrollTo(0,0),initCookieViews(),resetSecondCursorState(),scheduleScrollRefresh(),scheduleScrollRefresh(250)}),$(window).width()>540&&barba.hooks.leave(()=>{$(".btn-hamburger, .btn-menu").removeClass("active"),$("main").removeClass("nav-active")}),typeof barbaPrefetch!="undefined"&&barba.use(barbaPrefetch),barba.init({sync:!0,debug:!1,timeout:7e3,transitions:[{name:"default",once(i){e(i.next.container),initScript(),initCookieViews(),initLoader()},async leave(i){pageTransitionIn(i.current),await delay(495),i.current.container.remove()},async enter(i){pageTransitionOut(i.next),initNextWord(i)},async beforeEnter(i){ScrollTrigger.getAll().forEach(t=>t.kill()),scroll.destroy(),e(i.next.container),initScript()}},{name:"to-home",from:{},to:{namespace:["home"]},once(i){e(i.next.container),initScript(),initCookieViews(),initLoaderHome()}}]});function e(i){scroll=new LocomotiveScroll({el:i.querySelector("[data-scroll-container]"),smooth:!0,scrollFromAnywhere:!0}),window.__mattiaLocoResizeHandler&&window.removeEventListener("resize",window.__mattiaLocoResizeHandler),window.__mattiaLocoResizeHandler=()=>{scroll&&typeof scroll.update=="function"&&scroll.update()},window.addEventListener("resize",window.__mattiaLocoResizeHandler,{passive:!0}),scroll.on("scroll",()=>ScrollTrigger.update()),ScrollTrigger.scrollerProxy("[data-scroll-container]",{scrollTop(o){return arguments.length?scroll.scrollTo(o,0,0):scroll.scroll.instance.scroll.y},getBoundingClientRect(){return{top:0,left:0,width:window.innerWidth,height:window.innerHeight}},pinType:i.querySelector("[data-scroll-container]").style.transform?"transform":"fixed"}),ScrollTrigger.defaults({scroller:document.querySelector("[data-scroll-container]")});const t=selectAll(".c-scrollbar");t.length>1&&t[0].remove(),window.__mattiaScrollTriggerRefreshHandler&&ScrollTrigger.removeEventListener("refresh",window.__mattiaScrollTriggerRefreshHandler),window.__mattiaScrollTriggerRefreshHandler=()=>{scroll&&typeof scroll.update=="function"&&scroll.update()},ScrollTrigger.addEventListener("refresh",window.__mattiaScrollTriggerRefreshHandler),ScrollTrigger.refresh()}}function initNextWord(e){let o=new DOMParser().parseFromString(e.next.html,"text/html").querySelector(".loading-words");document.querySelector(".loading-words").innerHTML=o.innerHTML}function delay(e){return e=e||2e3,new Promise(i=>{setTimeout(()=>{i()},e)})}function initScript(){select("body").classList.remove("is-loading"),initWindowInnerheight(),initCheckTouchDevice(),initSecondCursor(),initHamburgerNav(),initDynamicNotch(),initMagneticButtons(),initStickyCursorWithDelay(),initVisualFilter(),initScrolltriggerNav(),initScrollLetters(),initTricksWords(),initContactForm(),initTimeZone(),initLazyLoad(),initPlayVideoInview(),initScrolltriggerAnimations(),scheduleScrollRefresh(),scheduleScrollRefresh(250)}function initWindowInnerheight(){window.__mattiaSetVh||(window.__mattiaSetVh=function(){const e=window.innerHeight*.01;document.documentElement.style.setProperty("--vh",`${e}px`)}),window.__mattiaVhListenersBound||(window.addEventListener("resize",window.__mattiaSetVh),window.addEventListener("orientationchange",window.__mattiaSetVh),window.__mattiaVhListenersBound=!0),window.__mattiaSetVh()}function initCheckTouchDevice(){if(window.__mattiaDetectTouchMode||(window.__mattiaDetectTouchMode=function(){return!!((window.matchMedia?window.matchMedia("(hover: none), (pointer: coarse)").matches:!1)||"ontouchstart"in window||navigator.maxTouchPoints)}),window.__mattiaApplyTouchModeClasses||(window.__mattiaApplyTouchModeClasses=function(e){const i=document.documentElement,t="touch-device",o="no-touch-device",l=e?t:o,a=e?o:t;i.classList.contains(l)||i.classList.add(l),i.classList.remove(a)}),!window.__mattiaTouchModeListenersBound){const e=()=>{window.__mattiaApplyTouchModeClasses(window.__mattiaDetectTouchMode())};window.addEventListener("resize",e),window.addEventListener("orientationchange",e),window.__mattiaTouchModeListenersBound=!0}window.__mattiaApplyTouchModeClasses(window.__mattiaDetectTouchMode())}function initCLSDebugObserver(){if(window.__clsDebugInitialized||new URLSearchParams(window.location.search).get("clsdebug")!=="1")return;window.__clsDebugInitialized=!0;const i=()=>{const o=document.querySelector("main[data-barba-namespace]");return o&&o.getAttribute("data-barba-namespace")||"unknown"},t={value:0,entries:[],topEntries(o=10){return this.entries.slice().sort((l,a)=>a.value-l.value).slice(0,o)}};if(window.__clsDebug=t,!("PerformanceObserver"in window)){t.unsupported=!0;return}try{const o=new PerformanceObserver(l=>{l.getEntries().forEach(a=>{if(a.hadRecentInput)return;const r=Array.isArray(a.sources)?a.sources.slice(0,3).map(s=>{const m=s&&s.node;let g="";if(m&&m.nodeType===1){const p=m.id?`#${m.id}`:"",d=typeof m.className=="string"?m.className.trim().split(/\s+/).filter(Boolean).slice(0,3).map(f=>`.${f}`).join(""):"";g=`${m.nodeName.toLowerCase()}${p}${d}`}return{value:s&&typeof s.value=="number"?s.value:0,selector:g}}):[];t.value+=a.value,t.entries.push({value:a.value,startTime:a.startTime,namespace:i(),sources:r}),t.entries.length>200&&t.entries.shift()})});o.observe({type:"layout-shift",buffered:!0}),t.disconnect=()=>o.disconnect()}catch(o){t.error=o&&o.message?o.message:"Failed to initialize CLS debug observer"}}function initHamburgerNav(){$(document).off("mouseenter.mattiaNav mouseleave.mattiaNav",".btn-hamburger, .btn-menu").on("mouseenter.mattiaNav",".btn-hamburger, .btn-menu",function(){setSecondCursorHidden(!0)}).on("mouseleave.mattiaNav",".btn-hamburger, .btn-menu",function(){setSecondCursorHidden(!1)}),$(document).off("click.mattiaNav",".btn-hamburger, .btn-menu").on("click.mattiaNav",".btn-hamburger, .btn-menu",function(){$(".btn-hamburger, .btn-menu").hasClass("active")?($(".btn-hamburger, .btn-menu").removeClass("active"),$("main").removeClass("nav-active"),scroll&&typeof scroll.start=="function"&&scroll.start()):($(".btn-hamburger, .btn-menu").addClass("active"),$("main").addClass("nav-active"),scroll&&typeof scroll.stop=="function"&&scroll.stop())}),$(document).off("click.mattiaNav",".fixed-nav-back").on("click.mattiaNav",".fixed-nav-back",function(){$(".btn-hamburger, .btn-menu").removeClass("active"),$("main").removeClass("nav-active"),scroll&&typeof scroll.start=="function"&&scroll.start()}),$(document).off("keydown.mattiaNav").on("keydown.mattiaNav",function(e){e.keyCode==27&&$("main").hasClass("nav-active")&&($(".btn-hamburger, .btn-menu").removeClass("active"),$("main").removeClass("nav-active"),scroll&&typeof scroll.start=="function"&&scroll.start())})}function initMagneticButtons(){var e=Array.from(document.querySelectorAll(".magnetic")),i=new WeakMap,t=new WeakMap;function o(a){if(a){var r=t.get(a);r||(r=a.querySelector(".btn-text"),t.set(a,r||null));var s=a.getBoundingClientRect();i.set(a,{left:s.left,top:s.top,width:s.width||a.offsetWidth||1,height:s.height||a.offsetHeight||1,textNode:r})}}function l(a){var r=a.currentTarget,s=i.get(r);if(s||(o(r),s=i.get(r)),!!s){var m=Number(r.getAttribute("data-strength")||0),g=Number(r.getAttribute("data-strength-text")||0),p=(a.clientX-s.left)/s.width-.5,d=(a.clientY-s.top)/s.height-.5;gsap.to(r,1.5,{x:p*m,y:d*m,rotate:"0.001deg",ease:Power4.easeOut}),s.textNode&&gsap.to(s.textNode,1.5,{x:p*g,y:d*g,rotate:"0.001deg",ease:Power4.easeOut})}}window.__mattiaMagneticResizeHandler&&window.removeEventListener("resize",window.__mattiaMagneticResizeHandler),window.__mattiaMagneticResizeRaf&&(cancelAnimationFrame(window.__mattiaMagneticResizeRaf),window.__mattiaMagneticResizeRaf=null),window.__mattiaMagneticResizeHandler=function(){window.__mattiaMagneticResizeRaf&&cancelAnimationFrame(window.__mattiaMagneticResizeRaf),window.__mattiaMagneticResizeRaf=requestAnimationFrame(function(){e.forEach(function(a){o(a)}),window.__mattiaMagneticResizeRaf=null})},window.addEventListener("resize",window.__mattiaMagneticResizeHandler,{passive:!0}),window.innerWidth>540&&(e.forEach(a=>{a.dataset.magneticBound!=="true"&&(a.dataset.magneticBound="true",o(a),a.addEventListener("mouseenter",function(r){o(r.currentTarget)},{passive:!0}),a.addEventListener("mousemove",l),a.addEventListener("mouseleave",function(r){gsap.to(r.currentTarget,1.5,{x:0,y:0,ease:Elastic.easeOut});var s=i.get(r.currentTarget);s&&s.textNode&&gsap.to(s.textNode,1.5,{x:0,y:0,ease:Elastic.easeOut})}))}),$(document).off("mouseenter.mattiaMagnetic mouseleave.mattiaMagnetic",".magnetic, .work-items").on("mouseenter.mattiaMagnetic",".magnetic, .work-items",function(){setSecondCursorHidden(!0)}).on("mouseleave.mattiaMagnetic",".magnetic, .work-items",function(){setSecondCursorHidden(!1)})),$(document).off("mouseenter.mattiaMagneticButtons",".btn-click.magnetic").on("mouseenter.mattiaMagneticButtons",".btn-click.magnetic",function(){$(this).find(".btn-fill").length&&gsap.to($(this).find(".btn-fill"),.6,{startAt:{y:"76%"},y:"0%",ease:Power2.easeInOut}),$(this).find(".btn-text-inner.change").length&&gsap.to($(this).find(".btn-text-inner.change"),.3,{startAt:{color:"#1C1D20"},color:"#FFFFFF",ease:Power3.easeIn}),$(this.parentNode).removeClass("not-active")}),$(document).off("mouseleave.mattiaMagneticButtons",".btn-click.magnetic").on("mouseleave.mattiaMagneticButtons",".btn-click.magnetic",function(){$(this).find(".btn-fill").length&&gsap.to($(this).find(".btn-fill"),.6,{y:"-76%",ease:Power2.easeInOut}),$(this).find(".btn-text-inner.change").length&&gsap.to($(this).find(".btn-text-inner.change"),.3,{color:"#1C1D20",ease:Power3.easeOut,delay:.3}),$(this.parentNode).removeClass("not-active")})}function initStickyCursorWithDelay(){var e=$(".mouse-pos-list-image"),i=$(".mouse-pos-list-btn"),t=$(".mouse-pos-list-span"),o=0,l=0,a=0,r=0,s=0,m=0,g=0,p=0;stickyCursorTicker&&(stickyCursorTicker.kill(),stickyCursorTicker=null),document.querySelector(".mouse-pos-list-image, .mouse-pos-list-btn, .mouse-post-list-span")&&(stickyCursorTicker=gsap.to({},.0083333333,{repeat:-1,onRepeat:function(){document.querySelector(".mouse-pos-list-image")&&(o+=(g-o)/12,l+=(p-l)/12,gsap.set(e,{x:o,y:l,xPercent:-50,yPercent:-52,force3D:!0})),document.querySelector(".mouse-pos-list-btn")&&(a+=(g-a)/7,r+=(p-r)/7,gsap.set(i,{x:a,y:r,xPercent:-50,yPercent:-60,force3D:!0})),document.querySelector(".mouse-pos-list-span")&&(s+=(g-s)/6,m+=(p-m)/6,gsap.set(t,{x:s,y:m,xPercent:-50,yPercent:-60,force3D:!0}))}})),$(document).off("mouseenter.mattiaStickyCursor mouseleave.mattiaStickyCursor",".mouse-pos-list-image, .mouse-pos-list-btn, .mouse-post-list-span").on("mouseenter.mattiaStickyCursor",".mouse-pos-list-image, .mouse-pos-list-btn, .mouse-post-list-span",function(){setSecondCursorHidden(!0)}).on("mouseleave.mattiaStickyCursor",".mouse-pos-list-image, .mouse-pos-list-btn, .mouse-post-list-span",function(){setSecondCursorHidden(!1)}),$(document).off("mousemove.mattiaStickyCursor").on("mousemove.mattiaStickyCursor",function(d){g=d.clientX,p=d.clientY}),$(document).off("mouseenter.mattiaStickyCursor",".mouse-pos-list-image-wrap a").on("mouseenter.mattiaStickyCursor",".mouse-pos-list-image-wrap a",function(){$(".mouse-pos-list-image, .mouse-pos-list-btn, .mouse-pos-list-span, .mouse-pos-list-span-big").addClass("active")}),$(document).off("mouseleave.mattiaStickyCursor",".mouse-pos-list-image-wrap a").on("mouseleave.mattiaStickyCursor",".mouse-pos-list-image-wrap a",function(){$(".mouse-pos-list-image, .mouse-pos-list-btn, .mouse-pos-list-span, .mouse-pos-list-span-big").removeClass("active")}),$(document).off("mouseenter.mattiaStickyCursor",".single-tile-wrap a, .mouse-pos-list-archive a, .next-case-btn").on("mouseenter.mattiaStickyCursor",".single-tile-wrap a, .mouse-pos-list-archive a, .next-case-btn",function(){$(".mouse-pos-list-btn, .mouse-pos-list-span").addClass("active-big")}),$(document).off("mouseleave.mattiaStickyCursor",".single-tile-wrap a, .mouse-pos-list-archive a, .next-case-btn").on("mouseleave.mattiaStickyCursor",".single-tile-wrap a, .mouse-pos-list-archive a, .next-case-btn",function(){$(".mouse-pos-list-btn, .mouse-pos-list-span").removeClass("active-big")}),$("main").off("mousedown.mattiaStickyCursor").on("mousedown.mattiaStickyCursor",function(){$(".mouse-pos-list-btn, .mouse-pos-list-span").addClass("pressed")}),$("main").off("mouseup.mattiaStickyCursor").on("mouseup.mattiaStickyCursor",function(){$(".mouse-pos-list-btn, .mouse-pos-list-span").removeClass("pressed")}),$(document).off("mouseenter.mattiaStickyCursor mouseleave.mattiaStickyCursor",".mouse-pos-list-image-wrap, .single-tile-wrap").on("mouseenter.mattiaStickyCursor",".mouse-pos-list-image-wrap, .single-tile-wrap",function(){setSecondCursorHidden(!0)}).on("mouseleave.mattiaStickyCursor",".mouse-pos-list-image-wrap, .single-tile-wrap",function(){setSecondCursorHidden(!1)}),$(document).off("mouseenter.mattiaStickyCursor",".mouse-pos-list-image-wrap li.visible").on("mouseenter.mattiaStickyCursor",".mouse-pos-list-image-wrap li.visible",function(){var d=$(".mouse-pos-list-image-wrap li.visible"),f=d.index($(this)),b=$(".mouse-pos-list-image li.visible").length;$(".float-image-wrap")&&gsap.to($(".float-image-wrap"),{y:f*100/(b*-1)+"%",duration:.6,ease:Power2.easeInOut}),$(".mouse-pos-list-image.active .mouse-pos-list-image-bounce").addClass("active").delay(400).queue(function(k){$(this).removeClass("active"),k()})}),$(document).off("mouseenter.mattiaStickyCursor",".archive-work-grid li").on("mouseenter.mattiaStickyCursor",".archive-work-grid li",function(){$(".mouse-pos-list-btn").addClass("hover").delay(100).queue(function(d){$(this).removeClass("hover"),d()})})}function initVisualFilter(){$(document).ready(function(){$(".toggle-row .btn").off("click.mattiaVisualFilter").on("click.mattiaVisualFilter",function(){$(this).hasClass("active")||($(".work-tiles li, .work-items li").addClass("tile-fade-out"),scroll.stop(),setTimeout(function(){$(".work-tiles li, .work-items li").removeClass("tile-fade-out"),$(".work-tiles li, .work-items li").addClass("tile-fade-in"),scroll.scrollTo("top",{offset:0,duration:700,easing:[.7,0,.35,1],disableLerp:!0})},300),setTimeout(function(){$(".work-tiles li, .work-items li").removeClass("tile-fade-in"),scroll.update(),ScrollTrigger.refresh(),scroll.start()},700))}),$(".all-btn").off("click.mattiaVisualFilter").on("click.mattiaVisualFilter",function(){$(this).hasClass("active")||($(".toggle-row .btn-normal").removeClass("active"),$(".toggle-row .btn-normal").addClass("not-active"),$(this).addClass("active"),$(this).removeClass("not-active"),setTimeout(function(){$(".mouse-pos-list-image li, .mouse-pos-list-image-wrap li, .work-tiles li").addClass("visible")},300))}),$(".first-work-category-btn").off("click.mattiaVisualFilter").on("click.mattiaVisualFilter",function(){$(this).hasClass("active")||($(".toggle-row .btn-normal").removeClass("active"),$(".toggle-row .btn-normal").addClass("not-active"),$(this).addClass("active"),$(this).removeClass("not-active"),setTimeout(function(){$(".mouse-pos-list-image li, .mouse-pos-list-image-wrap li, .work-tiles li").removeClass("visible"),$(".mouse-pos-list-image li.first-work-category, .mouse-pos-list-image-wrap li.first-work-category, .work-tiles li.first-work-category").addClass("visible")},300))}),$(".second-work-category-btn").off("click.mattiaVisualFilter").on("click.mattiaVisualFilter",function(){$(this).hasClass("active")||($(".toggle-row .btn-normal").removeClass("active"),$(".toggle-row .btn-normal").addClass("not-active"),$(this).addClass("active"),$(this).removeClass("not-active"),setTimeout(function(){$(".mouse-pos-list-image li, .mouse-pos-list-image-wrap li, .work-tiles li").removeClass("visible"),$(".mouse-pos-list-image li.second-work-category, .mouse-pos-list-image-wrap li.second-work-category, .work-tiles li.second-work-category").addClass("visible")},300))}),$(".grid-row .btn").off("click.mattiaVisualFilter").on("click.mattiaVisualFilter",function(){$(this).hasClass("active")||($(".grid-fade").addClass("grid-fade-out"),scroll.stop(),scroll.scrollTo("top",{offset:0,duration:700,easing:[.7,0,.35,1],disableLerp:!0}),setTimeout(function(){$(".grid-fade").removeClass("grid-fade-out"),$(".grid-fade").addClass("grid-fade-in")},300),setTimeout(function(){$(".grid-fade").removeClass("grid-fade-in"),scroll.update(),ScrollTrigger.refresh(),scroll.start()},700))}),$(".grid-row .rows-btn").off("click.mattiaVisualFilter").on("click.mattiaVisualFilter",function(){$(this).hasClass("active")||($(".grid-row .btn-normal").removeClass("active"),$(".grid-row .btn-normal").addClass("not-active"),Cookies.set("view","rows",{expires:14}),$(this).addClass("active"),$(this).removeClass("not-active"),setTimeout(function(){$(".grid-columns-part").removeClass("visible"),$(".grid-rows-part").addClass("visible")},300))}),$(".grid-row .columns-btn").off("click.mattiaVisualFilter").on("click.mattiaVisualFilter",function(){$(this).hasClass("active")||($(".grid-row .btn-normal").removeClass("active"),$(".grid-row .btn-normal").addClass("not-active"),Cookies.set("view","columns",{expires:14}),$(this).addClass("active"),$(this).removeClass("not-active"),setTimeout(function(){$(".grid-rows-part").removeClass("visible"),$(".grid-columns-part").addClass("visible")},300))})})}function initCookieViews(){const e=document.documentElement,i="prefers-work-columns";if(!(Cookies.get("view")=="columns")){e.classList.remove(i);return}const o=document.querySelector("#work .grid-rows-part"),l=document.querySelector("#work .grid-columns-part");if(!o||!l){e.classList.remove(i);return}const a=!!(o&&l&&!o.classList.contains("visible")&&l.classList.contains("visible"));$(".grid-row .rows-btn").removeClass("active"),$(".grid-row .columns-btn").addClass("active"),a||(o&&o.classList.remove("visible"),l&&l.classList.add("visible"),scroll&&typeof scroll.update=="function"&&scroll.update(),ScrollTrigger.refresh()),e.classList.remove(i)}function initScrolltriggerNav(){ScrollTrigger.create({start:"top -30%",onUpdate:e=>{$("main").addClass("scrolled")},onLeaveBack:()=>{$("main").removeClass("scrolled")}})}function initScrollLetters(){window.__mattiaScrollLettersCleanup&&(window.__mattiaScrollLettersCleanup(),window.__mattiaScrollLettersCleanup=null);let e=1;const i=[],t=a(".big-name .name-wrap",{duration:18}),o=a(".rollingText02",{duration:10},!0),l=ScrollTrigger.create({trigger:document.querySelector("[data-scroll-container]"),onUpdate(r){r.direction!==e&&(e*=-1,gsap.to([t,o],{timeScale:e,overwrite:!0}))}});i.push(function(){l&&typeof l.kill=="function"&&l.kill()}),window.__mattiaScrollLettersCleanup=function(){i.forEach(function(r){r()}),i.length=0,window.__mattiaScrollLettersCleanup=null};function a(r,s,m){s=s||{},s.ease||(s.ease="none");const g=gsap.timeline({repeat:-1,onReverseComplete(){this.totalTime(this.rawTime()+this.duration()*10)}}),p=gsap.utils.toArray(r),d=p.map(h=>{let c=h.cloneNode(!0);return h.parentNode.appendChild(c),c});let f=0;function b(){const h=p.map(c=>({top:c.offsetTop,left:c.offsetLeft+(m?-c.offsetWidth:c.offsetWidth)}));gsap.set(d,{position:"absolute",overwrite:!1}),h.forEach((c,S)=>{gsap.set(d[S],{top:c.top,left:c.left})})}function k(){let h=g.totalTime();g.totalTime(0),b(),g.totalTime(h)}function v(){f&&cancelAnimationFrame(f),f=requestAnimationFrame(()=>{k(),f=0})}return p.length&&(b(),p.forEach((h,c)=>g.to([h,d[c]],{xPercent:m?100:-100,...s},0)),window.addEventListener("resize",v,{passive:!0}),i.push(function(){window.removeEventListener("resize",v),f&&(cancelAnimationFrame(f),f=0),d.forEach(h=>{h&&h.parentNode&&h.parentNode.removeChild(h)}),g.kill()})),g}}function initTricksWords(){for(var e=document.getElementsByClassName("span-lines"),i=0;i<e.length;i++){var t=e.item(i);t&&(t.querySelector(".span-line")||(t.innerHTML=t.innerHTML.replace(/(^|<\/?[^>]+>|\s+)([^\s<]+)/g,'$1<span class="span-line"><span class="span-line-inner">$2</span></span>')),t.classList.add("is-split-ready"))}}function initContactForm(){$(".field").off("input.mattiaContact").on("input.mattiaContact",function(){$(this).parent().toggleClass("not-empty",this.value.trim().length>0)}),$(".field").off("focusout.mattiaContact").on("focusout.mattiaContact",function(){var e=$(this).val();$(this).parent().toggleClass("not-empty",e!=="")}).trigger("focusout")}function initDynamicNotch(){dynamicNotchCleanup&&(dynamicNotchCleanup(),dynamicNotchCleanup=null);const e=document.querySelector(".dynamic-notch");e&&e.remove();const i=()=>{const n=window.innerWidth<=540,u=397.44,w=466.82,y=60,C=124,x=document.querySelector(".btn-hamburger .btn-click"),L=x?parseFloat(window.getComputedStyle(x).height):64,T=Number.isFinite(L)&&L>0?L:64,I=T*.75,z=I*(127/36),W=366,G=208,D=Math.max(1,window.innerWidth-16),B=Math.min(z,D),Y=Math.min(W,D),U=B/z,j=Y/W,Z=Math.round(I*U);return{closedWidth:n?B:Math.min(u,window.innerWidth-24),openWidth:n?Y:Math.min(w,window.innerWidth-24),closedHeight:n?Z:y,openHeight:n?Math.round(G*j):C,closedOffsetY:n?Math.max(0,(T-Z)/2):0,openOffsetY:0}},t=document.createElement("div");t.className="dynamic-notch",t.innerHTML=`
    ...
    `;const o=t.querySelector(".dynamic-notch-shell"),l=t.querySelector(".dynamic-notch-expanded"),a=t.querySelector(".dynamic-notch-time"),r=Array.from(t.querySelectorAll(".dynamic-notch-expanded a"));if(!o||!l||!a){t.remove();return}const s=i();o.style.setProperty("--dynamic-notch-compact-height",`${s.closedHeight}px`),o.style.setProperty("--dynamic-notch-expanded-row-height",`${s.openHeight-s.closedHeight}px`),o.style.width=`${s.closedWidth}px`,o.style.height=`${s.closedHeight}px`,body.appendChild(t),gsap.set(o,{y:s.closedOffsetY});const m=()=>{const n=document.createElement("div");n.style.cssText="position:fixed;top:env(safe-area-inset-top,0px);left:0;width:1px;height:1px;visibility:hidden;pointer-events:none;",body.appendChild(n);const u=n.getBoundingClientRect().top;n.remove(),t.classList.toggle("is-floating",u>4)};m();const g=new Intl.DateTimeFormat([],{timeZone:"Europe/Amsterdam",hour:"2-digit",minute:"2-digit",hour12:!0}),p=()=>window.matchMedia("(hover: none), (pointer: coarse)").matches,d=()=>window.innerWidth<=540,f=n=>{o.setAttribute("aria-expanded",n?"true":"false"),o.setAttribute("aria-label",n?"Close profile quick links":"Open profile quick links"),l.setAttribute("aria-hidden",n?"false":"true"),r.forEach(u=>{u.tabIndex=n?0:-1})},b=()=>{a.textContent=g.format(new Date)};b();const k=window.setInterval(b,1e3);let v=!1;const h=n=>{o.style.setProperty("--dynamic-notch-compact-height",`${n.closedHeight}px`),o.style.setProperty("--dynamic-notch-expanded-row-height",`${n.openHeight-n.closedHeight}px`)},c=n=>{const u=n;if(u===!1&&t.classList.remove("is-touch-expanded"),v===u&&!(dynamicNotchTimeline!=null&&dynamicNotchTimeline.isActive()))return;v=u,t.classList.toggle("is-expanded",u),f(u),dynamicNotchTimeline&&dynamicNotchTimeline.kill();const w=i();h(w);const y=window.matchMedia("(prefers-reduced-motion: reduce)").matches,C=d(),x=y?.16:C?.42:.8,L=y?.12:C?.26:.45,T=C?"power3.out":"elastic.out(1, 0.72)";u?(dynamicNotchTimeline=gsap.timeline(),dynamicNotchTimeline.to(o,{width:w.openWidth,height:w.openHeight,y:w.openOffsetY,duration:x,ease:T},0).to(l,{autoAlpha:1,y:0,duration:L,ease:"power3.out"},y?0:C?.12:.22)):(dynamicNotchTimeline=gsap.timeline(),dynamicNotchTimeline.to(l,{autoAlpha:0,y:12,duration:y?.1:.22,ease:"power2.in"},0).to(o,{width:w.closedWidth,height:w.closedHeight,y:w.closedOffsetY,duration:x,ease:T},y?0:.04))},S=()=>{m();const n=i();o.tabIndex=0,o.removeAttribute("aria-disabled"),h(n),gsap.set(o,{width:v?n.openWidth:n.closedWidth,height:v?n.openHeight:n.closedHeight,y:v?n.openOffsetY:n.closedOffsetY})},H=()=>{const n=document.querySelector("main");t.classList.toggle("is-nav-obscured",!!(n&&n.classList.contains("nav-active")))},_=n=>{setSecondCursorHidden(n)},A=()=>{!p()&&!d()&&(_(!0),c(!0))},P=()=>{!p()&&!t.contains(document.activeElement)&&c(!1),_(!1)},N=()=>{d()||c(!0)},F=n=>{const u=n.relatedTarget;u&&t.contains(u)||t.classList.contains("is-touch-expanded")||c(!1)},V=n=>{if(d()){if(n.target.closest(".dynamic-notch-expanded a"))return;n.preventDefault(),n.stopPropagation();const w=!t.classList.contains("is-expanded");t.classList.toggle("is-touch-expanded",w),c(w);return}if(!p())return;if(n.target.closest("a")){t.classList.contains("is-expanded")&&(t.classList.remove("is-touch-expanded"),c(!1));return}n.preventDefault(),n.stopPropagation();const u=!t.classList.contains("is-expanded");t.classList.toggle("is-touch-expanded",u),c(u)},q=n=>{t.classList.contains("is-touch-expanded")&&(t.contains(n.target)||(t.classList.remove("is-touch-expanded"),c(!1)))},R=n=>{if(!((n.key==="Enter"||n.key===" ")&&n.target!==o)){if(n.key==="Enter"||n.key===" "){n.preventDefault();const u=!t.classList.contains("is-expanded");t.classList.toggle("is-touch-expanded",u),c(u)}n.key==="Escape"&&(t.classList.remove("is-touch-expanded"),c(!1),o.blur())}},M=document.querySelector("main"),E=M?new MutationObserver(H):null;E&&M&&E.observe(M,{attributes:!0,attributeFilter:["class"]});const X=()=>{t.classList.remove("is-touch-expanded"),c(!1),document.activeElement&&t.contains(document.activeElement)&&document.activeElement.blur(),o.blur()},O=()=>{X()};gsap.set(l,{autoAlpha:0,y:12}),f(!1),S(),H(),t.addEventListener("mouseenter",A),t.addEventListener("mouseleave",P),t.addEventListener("focusin",N),t.addEventListener("focusout",F),o.addEventListener("click",V),o.addEventListener("keydown",R),r.forEach(n=>{n.addEventListener("click",O)}),document.addEventListener("pointerdown",q),window.addEventListener("resize",S),dynamicNotchCleanup=()=>{window.clearInterval(k),window.removeEventListener("resize",S),document.removeEventListener("pointerdown",q),r.forEach(n=>{n.removeEventListener("click",O)}),o.removeEventListener("keydown",R),o.removeEventListener("click",V),t.removeEventListener("focusout",F),t.removeEventListener("focusin",N),t.removeEventListener("mouseleave",P),t.removeEventListener("mouseenter",A),E&&E.disconnect(),dynamicNotchTimeline&&(dynamicNotchTimeline.kill(),dynamicNotchTimeline=null),_(!1),t.remove()}}function initTimeZone(){const e=document.querySelector("#timeSpan"),i=document.querySelector(".credits p:nth-of-type(2)"),t={timeZone:"Europe/Amsterdam",timeZoneName:"short",hour:"2-digit",hour12:"true",minute:"numeric"},o=new Intl.DateTimeFormat([],t);a(),l(),window.__mattiaClockInterval&&window.clearInterval(window.__mattiaClockInterval),window.__mattiaClockInterval=window.setInterval(l,1e3);function l(){const r=new Date,s=o.format(r);e.textContent=s}function a(){const r=new Date().getFullYear();i.textContent=`${r} \xA9 Edition`}}function initLazyLoad(){var e=new LazyLoad({elements_selector:".lazy",callback_loaded:function(){scheduleScrollRefresh(),scheduleScrollRefresh(200)},callback_finish:function(){scheduleScrollRefresh()}})}function initPlayVideoInview(){gsap.utils.toArray(".playpauze").forEach((i,t)=>{let o=i.querySelector("video");ScrollTrigger.create({scroller:document.querySelector("[data-scroll-container]"),trigger:o,start:"0% 120%",end:"100% -20%",onEnter:()=>o.play(),onEnterBack:()=>o.play(),onLeave:()=>o.pause(),onLeaveBack:()=>o.pause()})})}function initScrolltriggerAnimations(){document.querySelector(".footer-wrap")&&$(".footer-wrap").each(function(e){let i=$(this),t=$(".btn-hamburger .btn-click");gsap.timeline({scrollTrigger:{trigger:i,start:"50% 100%",end:"100% 120%",scrub:0}}).from(t,{boxShadow:"0px 0px 0px 0px rgb(0, 0, 0)",ease:"none"})}),document.querySelector(".span-lines.animate")&&$(".span-lines.animate").each(function(e){let i=$(this),t=$(".span-lines.animate .span-line-inner"),o=gsap.timeline({scrollTrigger:{trigger:i,toggleActions:"play none none reset",start:"0% 100%",end:"100% 0%"}});t&&o.from(t,{y:"100%",stagger:.01,ease:"power3.out",duration:1,delay:0})}),document.querySelector(".fade-in.animate")&&$(".fade-in.animate").each(function(e){let i=$(this),t=$(this),o=gsap.timeline({scrollTrigger:{trigger:i,toggleActions:"play none none reset",start:"0% 110%",end:"100% 0%"}});t&&o.from(t,{y:"2em",opacity:0,ease:"expo.out",duration:1.75,delay:0})}),document.querySelector(".awwwards-badge")&&$(".awwwards-badge").each(function(e){let i=$(this),t=$(".awwwards-badge svg:nth-child(1)");gsap.timeline({scrollTrigger:{trigger:i,start:"0% 100%",end:"100% 0%",scrub:0}}).to(t,{rotate:-90,ease:"none"})}),ScrollTrigger.matchMedia({"(min-width: 721px)":function(){document.querySelector(".home-header .arrow")&&$(".home-header").each(function(e){let i=$(this),t=$(".home-header .arrow");gsap.timeline({scrollTrigger:{trigger:i,start:"100% 100%",end:"100% 0%",scrub:0}}).to(t,{rotate:90,ease:"none"},0)}),document.querySelector(".footer-footer-wrap")&&$(".footer-footer-wrap").each(function(e){let i=$(this),t=$(".footer-rounded-div .rounded-div-wrap"),o=$("footer .arrow");gsap.timeline({scrollTrigger:{trigger:i,start:"0% 100%",end:"100% 100%",scrub:0}}).to(t,{height:0,ease:"none"},0).from(o,{rotate:15,ease:"none"},0)}),document.querySelector(".footer-case-wrap")&&$(".footer-case-wrap").each(function(e){let i=$(this),t=$(".footer-rounded-div .rounded-div-wrap");gsap.timeline({scrollTrigger:{trigger:i,start:"0% 100%",end:"100% 100%",scrub:0}}).to(t,{height:0,ease:"none"},0)}),document.querySelector(".about-image .single-about-image")&&$(".about-image .single-about-image").each(function(e){let i=$(this),t=$(".about-image .arrow");gsap.timeline({scrollTrigger:{trigger:i,start:"15% 100%",end:"100% 0%",scrub:0}}).to(t,{rotate:60,ease:"none"},0)}),document.querySelector(".about-services")&&$(".about-services").each(function(e){let i=$(this),t=$(".about-header, .line-globe, .about-image, .about-services"),o=gsap.timeline({scrollTrigger:{trigger:i,start:"-25% 100%",end:"100% 100%",scrub:0}});o.set(t,{backgroundColor:"#FFFFFF"}),o.to(t,{backgroundColor:"#E9EAEB",ease:"none"})}),document.querySelector(".digital-ball .globe")&&$("main").each(function(e){let i=$(this),t=$(".digital-ball .globe");gsap.timeline({scrollTrigger:{trigger:i,start:"100% 100%",end:"100% 0%",scrub:0}}).to(t,{ease:"none",rotate:90})})},"(max-width: 720px)":function(){document.querySelector(".footer-wrap")&&$(".footer-wrap").each(function(e){let i=$(this),t=$(".footer-rounded-div .rounded-div-wrap");gsap.timeline({scrollTrigger:{trigger:i,start:"0% 100%",end:"100% 100%",scrub:0}}).to(t,{height:0,ease:"none"},0)})}})}
